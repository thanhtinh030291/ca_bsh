...
class ClaimController extends Controller
{
    ...
    public function letter($letter_template_id , $claim_id ,$export_letter_id = null){
        ...
        $SURGOP = $HBS_CL_CLAIM->HBS_CL_LINE->whereIn('PD_BEN_HEAD.ben_head',['SUR','SURI','RSUR'])->sum('app_amt');
        ...
        $OTHERGOP = $HBS_CL_CLAIM->HBS_CL_LINE->whereNotIn('PD_BEN_HEAD.ben_head',['RB','SUR','RSUR','RSUR','EXTB','ICU'])->sum('app_amt') + $adminfee;
